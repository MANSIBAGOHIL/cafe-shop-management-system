...
$sql = "SELECT brand_id, brand_name, brand_active, brand_status,categories_id FROM brands WHERE brand_status = 1";
       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> View Menu-Items</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Menu-Items</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add-brand.php"><button class="btn btn-primary">Add Item</button></a>
